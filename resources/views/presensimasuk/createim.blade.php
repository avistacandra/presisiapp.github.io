...
<a href="{{ route('im/index') }}" class="btn btn-secondary btn-sm"><< kembali </a>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="gurupiket_id" id="gurupiket_id" class="form-control select2" value="{{ Session::get('gurupiket_id') }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="siswa_id" id="siswa_id" class="form-control select2" value="{{ Session::get('siswa_id') }}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="kelas_id" id="kelas_id" class="form-control select2" value="{{ Session::get('kelas_id') }}">
