        ...
        Silahkan Input Kelas
                                    ...
                                    <select class="form-control form-control-sm" @error('thn_ajaran') is-invalid @enderror name="thn_ajaran" id="thn_ajaran">
                                            ...
                                            @for ($year = $startYear; $year <= $endYear; $year++)
                                                @php
                                                    ...
                                                    $isSelected = $tahunajaran->thn_ajaran === $optionValue || old('thn_ajaran') === $optionValue ? 'selected' : '';
                                                @endphp
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm @error('status_ta') is-invalid @enderror" name="status_ta" id="status_ta">
                                        ...
                                        <option value="Aktif" {{ old('status_ta', $tahunajaran->status_ta) == 'Aktif' ? 'selected' : '' }}>Aktif</option>
                                        <option value="Tidak Aktif" {{ old('status_ta', $tahunajaran->status_ta) == 'Tidak Aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                                    </select>
                                    @error('status_ta')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
